...
public class RemoveRaffle extends CommandBase {
    public static final RemoveRaffle INSTANCE = new RemoveRaffle();
    ...
    public RemoveRaffle() {
        super("删除抽奖",
                ...
                new MessageChainBuilder()
                        ...
                        .append(SwallowsBot.COMMAND_PREFIX + "删除抽奖 <页码> <序号>").append(CommandBase.WRAP)
                        .append("中止所选中的抽奖。").append(CommandBase.WRAP)
    ...
    public void execute(GroupMessageEvent event, List<String> args) {
        ...
        if(args.size() == 3) {
            ...
            if(Util.isInteger(args.get(1)) && Util.isInteger(args.get(2))) {
                ...
                Util.sendMessageToGroup(
                        new MessageChainBuilder()
                                .append("已终止该抽奖！").append(CommandBase.WRAP)
