...
public class GoRaffle extends CommandBase {
    public static final GoRaffle INSTANCE = new GoRaffle();
    ...
    public GoRaffle() {
        super("继续抽奖",
                ...
                new MessageChainBuilder()
                        ...
                        .append(SwallowsBot.COMMAND_PREFIX + "继续抽奖 <页码> <序号>").append(CommandBase.WRAP)
                        .append("继续所选中的抽奖。").append(CommandBase.WRAP)
        ...
        if(args.size() == 3) {
            ...
            if(Util.isInteger(args.get(1)) && Util.isInteger(args.get(2))) {
                ...
                if(raffle.getState() == 1) {
                    Util.sendMessageToGroup(
                            new MessageChainBuilder()
                                    .append("该抽奖一直在进行中！").append(CommandBase.WRAP)
                                    .build()
                            , event.getGroup()
                    );
                    return;
                ...
                Util.sendMessageToGroup(
                        new MessageChainBuilder()
                                .append("已再次启动该抽奖！").append(CommandBase.WRAP)
